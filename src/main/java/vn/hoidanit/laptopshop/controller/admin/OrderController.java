...
public class OrderController {
    ...
    public String getOrder(Model model, @PathVariable long id) {
        Order order = this.orderService.fetchAOrder(id);
    ...
    public String getUpdateOrderPage(Model model, @PathVariable long id) {
        Order currentOrder = this.orderService.fetchAOrder(id);
        model.addAttribute("currentOrder", currentOrder);
        return "admin/order/update";
    }

    @PostMapping("/admin/order/update")
    public String handleUpdateOrder(@ModelAttribute("currentOrder") Order currentOrder) {
        Order updateOrder = this.orderService.fetchAOrder(currentOrder.getId());
        if (updateOrder != null) {
